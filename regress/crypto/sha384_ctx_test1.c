...
main(void)
{
    ...
    bksmt_sha384_ctx_init(&ctx);
    bksmt_sha384_ctx_hash(&ctx, test1, 43);
    bksmt_sha384_ctx_finish(&ctx, res1);

    if (memcmp(res1, res1ch, 48) != 0)
        return 1;

    bksmt_sha384_ctx_init(&ctx);
    bksmt_sha384_ctx_hash(&ctx, test1, 20);
    bksmt_sha384_ctx_hash(&ctx, test1 + 20, 23);
    bksmt_sha384_ctx_finish(&ctx, res1);
    ...
    bksmt_sha384_ctx_init(&ctx);
    bksmt_sha384_ctx_hash(&ctx, test2, 178);
    bksmt_sha384_ctx_finish(&ctx, res2);

    if (memcmp(res2, res2ch, 48) != 0)
        return 3;

    bksmt_sha384_ctx_init(&ctx);
    bksmt_sha384_ctx_hash(&ctx, test2, 128);
    bksmt_sha384_ctx_hash(&ctx, test2 + 128, 1);
    bksmt_sha384_ctx_hash(&ctx, test2 + 129, 1);
    bksmt_sha384_ctx_hash(&ctx, test2 + 130, 48);
    bksmt_sha384_ctx_finish(&ctx, res2);
    ...
    bksmt_sha384_ctx_init(&ctx);
    bksmt_sha384_ctx_hash(&ctx, test3, 128);
    bksmt_sha384_ctx_finish(&ctx, res3);
