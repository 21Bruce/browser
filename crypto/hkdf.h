...
struct bksmt_sha256_hkdf_expand_ctx {
    struct bksmt_sha256_hmac_ctx hmctx;
};

struct bksmt_sha512_hkdf_expand_ctx {
    struct bksmt_sha512_hmac_ctx hmctx;
};
...
/* expand ctx init functions. Args: ctx, salt, saltlen */

void bksmt_sha256_hkdf_expand_ctx_init(struct bksmt_sha256_hkdf_extract_ctx *, unsigned char *, uint64_t len);

void bksmt_sha224_hkdf_expand_ctx_init(struct bksmt_sha256_hkdf_extract_ctx *, unsigned char *, uint64_t len);

void bksmt_sha512_hkdf_expand_ctx_init(struct bksmt_sha512_hkdf_extract_ctx *, unsigned char *, uint64_t len);

void bksmt_sha384_hkdf_expand_ctx_init(struct bksmt_sha512_hkdf_extract_ctx *, unsigned char *, uint64_t len);
